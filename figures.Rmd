...
```{r maps,fig.width=10,fig.height=8, echo=FALSE, eval=FALSE}
...
Partial R square values of all model predictors for each taxa. The upper plot displays Rsq values of the Model and NPP; the area highlighted in grey in the upper plot is the one shown in the bottom plot with the rest of predictors.
```{r model_coefs}
...
```{r coef_plots,fig.width=8,fig.height=4}
...
ggplot(coefs,aes(estimate,term,colour=sig))+
