...
mkplot <- function(var, colour, type="rect", xlab = "", title= "") {
  ...
  if (type=="rect") {
    ...
    g1 <- g1 + geom_point(aes(x={{var}}, y = mid), colour = colour, size=5) +
...
plot_list <- list(mkplot(NPP_mean, cols[1], xlab=expression(g~C/m^{2}/year), title="NPP"),
