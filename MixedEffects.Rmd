...
ggplot(gamm4_best_pred,aes(sample=.resid))+
    stat_qq()+stat_qq_line()+
    facet_wrap(~taxon,nrow=1)
```

**TO DO**: reconstruct ranef plots
...
- restructure to allow the rest of the stuff (prediction plots, restricted fits, etc etc etc)
