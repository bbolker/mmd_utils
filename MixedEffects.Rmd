...
ggplot(all_rsq,aes(Rsq,Effect,colour=taxon))+
...
gg_restr_biome <- ggplot(filter(coefs_restr,grpvar=="biome"),
                         aes(condval,grp,colour=taxon,shape=taxon))+
    geom_point()+facet_wrap(~term,scale="free_x",nrow=1)+
...
print(gg_restr_biome %+% filter(coefs_restr,grpvar=="flor_realms"))
```
