...
p1A <- plotfun(best_models$mamph_log) + coord_cartesian(ylim=c(0,5))+nolegend
p1B <- plotfun(best_models$mamph_log,backtrans=TRUE)+nolegend
p1C <- p1B+coord_cartesian(ylim=c(0,30))+nolegend
p1D <- plotfun(best_models$mamph_log,backtrans=TRUE,log="xy")+nolegend
cowplot::plot_grid(p1A,p1B,p1C,p1D)
##
##   + scale_y_log10(limits=c(0.8,110),oob=scales::squish)
## )
